...
INSERT INTO orders
    ...
    '2024-12-18', '2024-11-30');

INSERT INTO orders
	(orderID, customerID, orderDate, contactID, employeeID, 
    paymentDueDate, projectedDeliveryDate, methodID)
    VALUES('1007', '1728', '2024-11-20', '1064', '1004', 
    '2024-12-20'); -- Phone assistance
...
-- CHECK THE DISCOUNTS AGAIN!!!
-- ORDER DETAILS DATA ENGTRY 
...
INSERT INTO price
	(partID, priceEah, fromDate, toDate)
    VALUES('112', '0.75', '2024-11-01');

INSERT INTO price
	(partID, priceEah, fromDate, toDate)
    VALUES('113', '1.25', '2024-11-01');

INSERT INTO price
	(partID, priceEah, fromDate, toDate)
    VALUES('221', '75.00', '2024-11-01');

INSERT INTO price
	(partID, priceEah, fromDate, toDate)
    VALUES('222', '225.00', '2024-11-01');
    
INSERT INTO price
	(partID, priceEah, fromDate, toDate)
    VALUES('337', '74.00', '2024-11-01');
    
INSERT INTO price
	(partID, priceEah, fromDate, toDate)
    VALUES('338', '52.00', '2024-11-01');

INSERT INTO price
	(partID, priceEah, fromDate, toDate)
    VALUES('339', '60.00', '2024-11-01');

INSERT INTO price
	(partID, priceEah, fromDate, toDate)
    VALUES('443', '327.00', '2024-11-01');

INSERT INTO price
	(partID, priceEah, fromDate, toDate)
    VALUES('445', '17.50', '2024-11-01');
    
INSERT INTO price
	(partID, priceEah, fromDate, toDate)
    VALUES('1007', '3.14', '2024-11-01');
