...
CREATE TABLE orders (
    orderID INT(4) NOT NULL AUTO_INCREMENT, -- Auto-incremented order ID
    customerID INT(4) NOT NULL,             -- References customers table
    contactID INT(4) NOT NULL,              -- References contacts table
    employeeID INT(4) NOT NULL,             -- References employees table
    methodID INT(4),                        -- References shippingMethods table
    shippingAddressID INT(4),
    billingAddressID INT(4) NOT NULL,       -- References the addresses table
    ...
    FOREIGN KEY(billingAddressID) REFERENCES addresses(addressID), -- Billing address reference
...
ADD CONSTRAINT `FK_contacts_address` FOREIGN KEY (`addressID`) REFERENCES `addresses`(`addressID`);
*/
...
INSERT INTO addresses
    ...
    VALUES( 
    '111 Santa Anna Valley Road', 'Sacramento', 'CA', '94203');
...
INSERT INTO addresses
    ...
    address, city, state, zipCode)
    VALUES(
    '775 Normal Lane', 'Relational', 'KS', '66110');

INSERT INTO addresses
    (
    address, city, state, zipCode)
    VALUES(
    '237 Boyce Avenue', 'Codd', 'KS', '67444');

INSERT INTO addresses
    (
    address, city, state, zipCode)
    VALUES(
    '738 SW Gage Blvd', 'Topeka', 'KS', '66606');

INSERT INTO addresses
    (
    address, city, state, zipCode)
    VALUES(
    '4745 NW Hunters Ridge Cir', 'Topeka', 'KS', '66618');

INSERT INTO addresses
    (
    address, city, state, zipCode)
    VALUES(
    '16563 W 151st St', 'Oleathe', 'KS', '66206');

INSERT INTO addresses
    (
    address, city, state, zipCode)
    VALUES(
    '7732 E Central Ave', 'Whichita', 'KS', '67206');

INSERT INTO addresses
    (
    address, city, state, zipCode)
    VALUES(
    '7002 Johnson Dr', 'Mission', 'KS', '66202');

INSERT INTO addresses
    (
    address, city, state, zipCode)
    VALUES(
    '9474 Renner Blvd', 'Lanexa', 'KS', '6619');

INSERT INTO addresses
    (
    address, city, state, zipCode)
    VALUES(
    '150 Central Mall', 'Salina', 'KS', '57401');
...
VALUES 
    ...
    ('1801 Baltimore Ave', 'Kansas City', 'MO', '64108'),
    ('16919 Audrey St', 'Omaha', 'NE', '68136'),
    ('237 Boyce Avenue', 'Codd', 'KS', '67444'),
    ('1512 W Berwyn Ave', 'Chicago', 'IL', '60640'),
    ('110 E Water St', 'Decorah', 'IA', '52101'),
    ('2300 Muscatine Ave', 'Iowa City', 'IA', '52240');

INSERT INTO addresses (address, city, state, zipCode)
VALUES ('3236 N Rock Rd Ste 120', 'Wichita', 'KS', '67226');

INSERT INTO addresses (address, city, state, zipCode)
VALUES ('3457 Holdrege St', 'Lincoln', 'NE', '68503');

INSERT INTO addresses (address, city, state, zipCode)
VALUES ('2100 Norcor Ave', 'Coralville', 'IA', '52241');
...
INSERT INTO contacts (contactID, contactFirstName, contactLastName, customerID, phoneNumber) VALUES
('1007', 'Maria', 'Rodriguez', '1000', '2131092912'),
('1024', 'Steve', 'Walton', '1001', '8161329745'),
('1045', 'Barbara', 'Smith', '1008', '4021269604'),
('1064', 'Patricia', 'White', '1013', '3121216247'),
('1086', 'Robert', 'Thomas', '1020', '5151445162'),
('1091', 'Robert', 'White', '1022', '5151459846'),
('1041', 'William', 'Johnson', '1006', '4021015829'),
('1029', 'David', 'Rodriguez', '1003','9131415414');
...
-- orders
INSERT INTO orders
	(orderID, customerID, orderDate, contactID, employeeID, shippingAddressID, billingAddressID,
    paymentDueDate, projectedDeliveryDate, methodID)
    VALUES('1001', '1000', '2024-11-02', '1007', '1003', '1012', '1000', 
    '2024-12-02', '2024-11-16', '1001');

INSERT INTO orders
	(orderID, customerID, orderDate, contactID, employeeID, shippingAddressID, billingAddressID,
    paymentDueDate, projectedDeliveryDate, methodID)
    VALUES('1002', '1006', '2024-11-02', '1041', '1007', NULL, '1013',
    '2024-12-02', NULL, NULL); -- Phone Assistance

INSERT INTO orders
	(orderID, customerID, orderDate, contactID, employeeID, shippingAddressID, billingAddressID,
    paymentDueDate, projectedDeliveryDate, methodID)
    VALUES('1003', '1003', '2024-11-03', '1029', '1007', '1014', '1021', 
    '2024-12-02', '2024-11-17', '1002');

INSERT INTO orders
	(orderID, customerID, orderDate, contactID, employeeID, shippingAddressID, billingAddressID,
    paymentDueDate, projectedDeliveryDate, methodID)
    VALUES('1004', '1001', '2024-11-03', '1024', '1007', '1015', '1015',
    '2024-12-03', '2024-11-17', '1003');

INSERT INTO orders
	(orderID, customerID, orderDate, contactID, employeeID, shippingAddressID, billingAddressID,
    paymentDueDate, projectedDeliveryDate, methodID)
    VALUES('1005', '1008', '2024-11-09', '1045', '1007', '1016', '1022', 
    '2024-12-09', '2024-11-23', '1004');
    
INSERT INTO orders
	(orderID, customerID, orderDate, contactID, employeeID, shippingAddressID, billingAddressID,
    paymentDueDate, projectedDeliveryDate, methodID)
    VALUES('1006', '1004', '2024-11-18', '1032', '1007', '1017', '1003', 
    '2024-12-18', '2024-11-30', '1001');

INSERT INTO orders
	(orderID, customerID, orderDate, contactID, employeeID, shippingAddressID, billingAddressID,
    paymentDueDate, projectedDeliveryDate, methodID)
    VALUES('1007', '1013', '2024-11-20', '1064', '1004', '1018', '1018', 
    '2024-12-20', NULL, NULL); -- Phone assistance

INSERT INTO orders
	(orderID, customerID, orderDate, contactID, employeeID, shippingAddressID, billingAddressID,
    paymentDueDate, projectedDeliveryDate, methodID)
    VALUES('1008', '1020', '2024-11-20', '1086', '1006', '1019', '1019',
    '2024-12-20', '2024-12-04', '1005');

INSERT INTO orders
	(orderID, customerID, orderDate, contactID, employeeID, shippingAddressID, billingAddressID,
    paymentDueDate, projectedDeliveryDate, methodID)
    VALUES('1009', '1022', '2024-11-28', '1091', '1006', '1020', '1023', 
...
SELECT 
    o.orderID AS 'Order ID',  
    c.customerName AS 'Bill To Customer',  
    b_addr.address AS 'Bill To Address',  
    ct.phoneNumber AS 'Bill To Phone',  
    CONCAT(ct.contactFirstName, ' ', ct.contactLastName) AS 'Ship To Recipient',  
    s_addr.address AS 'Ship To Address',  
    ct.phoneNumber AS 'Ship To Phone',  
    o.paymentDueDate AS 'Payment Due',  
    e.firstName AS 'Salesperson First Name',  
    e.lastName AS 'Salesperson Last Name',  
    sm.carrier AS 'Shipping Method',  
    sm.shippingDesc AS 'Shipping Description',  
    od.quantity AS 'Qty',  
    p.productDescription AS 'Description',  
    pr.priceEach AS 'Unit Price',  
    od.discount AS 'Discount',  
    ROUND(od.quantity * pr.priceEach * (1 - COALESCE(od.discount, 0)), 2) AS 'Line Total',  
    ROUND(SUM(od.quantity * pr.priceEach * (1 - COALESCE(od.discount, 0))) 
          OVER (PARTITION BY o.orderID), 2) AS 'Order Total'  
FROM 
    orders o  
LEFT JOIN 
    customers c ON o.customerID = c.customerID  
...
LEFT JOIN 
    employees e ON o.employeeID = e.employeeID  
LEFT JOIN 
    shippingMethods sm ON o.methodID = sm.methodID  
LEFT JOIN 
    addresses b_addr ON o.billingAddressID = b_addr.addressID  
LEFT JOIN 
    addresses s_addr ON o.shippingAddressID = s_addr.addressID  
LEFT JOIN 
    orderDetails od ON o.orderID = od.orderID  
LEFT JOIN 
    products p ON od.partID = p.partID  
LEFT JOIN 
    price pr ON p.partID = pr.partID AND o.orderDate BETWEEN pr.fromDate AND COALESCE(pr.toDate, CURRENT_DATE)  
WHERE 
    o.orderID = 1006  
ORDER BY 
    od.partID;
